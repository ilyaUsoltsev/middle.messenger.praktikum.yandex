...
> extends HttpClient<SecurityDataType> {
  ...
  chats = {
    ...
    chatsCreate: (
      ...
      this.request<CreateChatResponse, HttpErrorBody | void>({
        path: `/chats`,
        method: "POST",
     ...
     */
    filesList: (id: number, params: RequestParams = {}) =>
     ...
     */
    commonList: (id: number, params: RequestParams = {}) =>
      this.request<ChatsResponse[], void>({
